...
parser.add_argument("--n_epochs", type=int, default=200, help="number of epochs (full training)")
...
print(f"Training complete! Final model saved as dcgan_generator_final.pth")